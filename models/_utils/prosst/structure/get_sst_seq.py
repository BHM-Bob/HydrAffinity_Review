...
from models._utils.prosst.structure.encoder.gvp import AutoGraphEncoder
from models._utils.prosst.structure.utils.data_utils import convert_graph, BatchSampler, extract_seq_from_pdb
from models._utils.prosst.structure.build_graph import generate_graph
from models._utils.prosst.structure.build_subgraph import generate_pos_subgraph
...
def pdb_conventer(
    ...
    for pdb_file in tqdm(pdb_files, leave=False):
        pdb_subgraphs, result_dict, node_count = handle_pdf_file(pdb_file)
